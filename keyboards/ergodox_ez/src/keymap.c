...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [3] = LAYOUT_ergodox_pretty(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    KC_TRANSPARENT, KC_F12,         KC_F7,          KC_F8,          KC_F9,          KC_PSCREEN,     KC_TRANSPARENT,                                 KC_TRANSPARENT, RGB_TOG,        RGB_MOD,        RGB_HUI,        RGB_SAI,        RGB_VAI,        KC_TRANSPARENT,
    KC_TRANSPARENT, MT_G(KC_F11),   MT_A(KC_F4),    MT_C(KC_F5),    MT_S(KC_F6),    KC_NO,                                                                          KC_NO,          MT_S(KC_MEDIA_PREV_TRACK),MT_C(KC_AUDIO_VOL_DOWN),MT_A(KC_AUDIO_VOL_UP),MT_G(KC_MEDIA_NEXT_TRACK),KC_TRANSPARENT,
